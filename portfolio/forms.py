...
class ArtworkForm(forms.ModelForm):
    image = forms.FileField(label="Изображение",widget=forms.FileInput(attrs={'class': 'button','id':'img_file'}))
    ...
    id = forms.CharField(label="id_img", widget=forms.TextInput(attrs={'class': 'txt-input'}))
